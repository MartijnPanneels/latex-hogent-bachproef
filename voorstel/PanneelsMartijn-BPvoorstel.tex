...
\begin{abstract}
  ...
  Deze toestellen zijn kwetsbaar voor cyberaanvallen omdat ze netwerkverbonden zijn en gevoelige patiëntendata verwerken. 
  De Cyber Resilience Act (CRA) en NIS2-richtlijn stellen strikte beveiligingseisen aan dergelijke systemen. 
  Dit onderzoek ontwikkelt een geconfigureerd embedded Linux edge-systeem voor zorg IT-infrastructuurleverancier Exensio dat voldoet aan deze wetgeving.
