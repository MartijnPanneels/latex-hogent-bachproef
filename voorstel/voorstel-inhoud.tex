...
\textcolor{red}{Aangezien dit apparaat bedoeld is voor een kritieke sector, de zorgsector, zal het mogelijk zijn dat een strengere configuratie van toepassing is.}

Dit onderzoek richt zich hoofdzakelijk op \textcolor{red}{hoe een embedded Linux systeem binnen een zorgnetwerk zo kan worden geconfigureerd dat het voldoet aan de vereisten van de Cyber Resilience Act en de NIS2‑richtlijn.} 
Het systeem zal ingezet worden in een gesimuleerd zorg-netwerk. \textcolor{red}{Het te configureren systeem moet ingeschakeld worden in een bestaande pipeline, zonder de werking ervan te verstoren.} 
Het onderzoek is specifiek gericht op een casus van \textcolor{red}{zorg IT‑infrastructuur\-leverancier} Exensio, maar de resultaten kunnen ook toegepast worden door andere leveranciers in deze sector.

In dit onderzoek wordt ook geanalyseerd \textcolor{red}{welke impact de voorgestelde beveiligingsconfiguratie heeft op de performantie van het systeem}.
%---------- Stand van zaken ---------------------------------------------------
...
Eerst wordt bepaald of het embedded Linux systeem kan worden beschouwd als een medisch hulpmiddel of een onderdeel daarvan, en dus binnen het toepassingsgebied van de MDR valt.
...
In het vervolg van het onderzoek wordt er momenteel van uitgegaan dat het systeem niet onder de MDR valt.
...
In dit onderdeel wordt de NIS2-richtlijn besproken \autocite{NIS2024}. 
Er wordt extra duiding gegeven over welke artikels relevant zijn voor deze specifieke casus.
...
Het systeem is een x86-based Debian Linux systeem en moet een minimale userspace hebben. De configuratie zal
...
\subsection{Requirements configureren}
  ...
  Tijdens de implementatiefase zal het plan uit de vorige fase worden omgezet naar een daadwerkelijke configuratie van het Linux systeem.  
